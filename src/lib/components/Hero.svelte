...
>
	<div class="z-20 flex-col hero-content lg:flex-row-reverse">
		<div>
			<h1 class="py-3 text-6xl font-bold lg:text-9xl">Your business.<br />Our solutions.</h1>
			<div class="max-w-3xl text-xl prose md:text-2xl lg:text-3xl;">
				...
				<button class="text-xl normal-case btn btn-primary">What are you planning?</button>
			</div>
		</div>
	</div>
</div>
