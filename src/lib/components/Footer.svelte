...
<footer class="grid items-center grid-cols-3 gap-8 p-10 bg-neutral text-neutral-content">
	<div class="h-full border-r-2 border-base-100">
	...
	<div class="h-full text-xl lowercase border-r-2 border-base-100">
	...
	<div class="h-full lowercase">
		...
		<p>
			...
			which we are satisfied with but you may want to check yourself (Formspree and Chatwoot). We
			gather some analytics data ourselves using a tool called 'Offen'. All data is deleted after
			six months. You can see the data we have about you (and delete it if you like) by accessing
			offen.traist.co.uk
		</p>
	</div>
</footer>
