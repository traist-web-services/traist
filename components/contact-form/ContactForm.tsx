...
export default function ContactForm() {
  ...
  return (
    <section className="flex flex-col items-center justify-center p-4 md:px-12 lg:p-24">
        <form className="flex-grow text-xl lg:text-2xl p-12 shadow-md rounded-lg w-full max-w-prose flex flex-col" id="contact-form">
          <h1 className="font-bold text-4xl md:text-6xl mb-4 mt-0">Get in touch</h1>
